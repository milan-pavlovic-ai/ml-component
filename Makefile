...
deploy: build
	...
	sam deploy --guided --capabilities CAPABILITY_NAMED_IAM --profile $(PROFILE) --parameter-overrides "StageParam=\"$(PROFILE)\"" --stack-name "pricing" --config-file "samconfig.toml" --config-env $(PROFILE) --confirm-changeset
